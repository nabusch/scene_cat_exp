...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/mathilde/Buschlab/scene_cat_exp/scene_cat_exp_2023.2.2/SceneCat_2023_2_key_resp.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if int(participant) % 2 == 0:
        num_participant = int(int(participant)/2)
        ...
        num_participant = int((int(participant)  + 1)/2)
    ...
    while continueRoutine:
        ...
        if consent_text.status == STARTED:
            ...
            if tThisFlip > 25-frameTolerance:
                ...
                consent_text.tStopRefresh = tThisFlipGlobal  # on global time
