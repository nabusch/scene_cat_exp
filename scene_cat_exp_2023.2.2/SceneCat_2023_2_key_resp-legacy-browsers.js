...
async function experimentInit() {
  ...
  memo_training_slider = new visual.Slider({
    ...
    labels: ["      d       sicher alt", "       f       eher alt", "      j      eher neu", "      k       sicher neu"], fontSize: 0.04, ticks: [1, 2, 3, 4],
...
function instructions_cat_2RoutineBegin(snapshot) {
  return async function () {
    ...
    instructions_cat_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bed_aRoutineBegin(snapshot) {
  return async function () {
    ...
    bed_aComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bed_random_isiRoutineBegin(snapshot) {
  return async function () {
    ...
    bed_random_isiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bed_pictureRoutineBegin(snapshot) {
  return async function () {
    ...
    bed_pictureComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bed_bRoutineBegin(snapshot) {
  return async function () {
    ...
    bed_bComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
