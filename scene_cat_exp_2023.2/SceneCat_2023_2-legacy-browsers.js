...
let expName = 'SceneCat_2023_2';  // from the Builder filename that created this script
let expInfo = {
    'participant': '',
    'Alter': '',
    'Geschlecht': '',
...
function data_safetyRoutineBegin(snapshot) {
  return async function () {
    ...
    data_safetyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function data_safety_2RoutineBegin(snapshot) {
  return async function () {
    ...
    data_safety_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instructions_catRoutineBegin(snapshot) {
  return async function () {
    ...
    instructions_catComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function category_test_textRoutineBegin(snapshot) {
  return async function () {
    ...
    category_test_textComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function cat_training_trialsLoopBegin(cat_training_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    cat_training_trials.forEach(function() {
...
function memo_training_trialsLoopBegin(memo_training_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    memo_training_trials.forEach(function() {
...
function categorization_trialsLoopBegin(categorization_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    categorization_trials.forEach(function() {
...
function kitchen_a_categorization_trialsLoopBegin(kitchen_a_categorization_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    kitchen_a_categorization_trials.forEach(function() {
...
function kitchen_a_memotestLoopBegin(kitchen_a_memotestLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    kitchen_a_memotest.forEach(function() {
...
function kitchen_b_categorization_trialsLoopBegin(kitchen_b_categorization_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    kitchen_b_categorization_trials.forEach(function() {
...
function kitchen_b_memotestLoopBegin(kitchen_b_memotestLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    kitchen_b_memotest.forEach(function() {
...
function living_a_categorization_trialsLoopBegin(living_a_categorization_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    living_a_categorization_trials.forEach(function() {
...
function living_a_memotestLoopBegin(living_a_memotestLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    living_a_memotest.forEach(function() {
...
function living_b_categorization_trialsLoopBegin(living_b_categorization_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    living_b_categorization_trials.forEach(function() {
...
function living_b_memotestLoopBegin(living_b_memotestLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    living_b_memotest.forEach(function() {
...
function bed_a_categorization_trialsLoopBegin(bed_a_categorization_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    bed_a_categorization_trials.forEach(function() {
...
function bed_a_memotestLoopBegin(bed_a_memotestLoopScheduler, snapshot) {
  return async function() {
    ...
    bed_a_memotest = new TrialHandler({
      psychoJS: psychoJS,
      nReps: bedroom_1, method: TrialHandler.Method.RANDOM,
      extraInfo: expInfo, originPath: undefined,
    ...
    // Schedule all the trials in the trialList:
    bed_a_memotest.forEach(function() {
...
function bed_b_categorization_trialsLoopBegin(bed_b_categorization_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    bed_b_categorization_trials.forEach(function() {
...
function bed_b_memotestLoopBegin(bed_b_memotestLoopScheduler, snapshot) {
  return async function() {
    ...
    bed_b_memotest = new TrialHandler({
      psychoJS: psychoJS,
      nReps: bedroom_2, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
    ...
    // Schedule all the trials in the trialList:
    bed_b_memotest.forEach(function() {
...
function fix_categorization_trainingRoutineBegin(snapshot) {
  return async function () {
    ...
    fix_categorization_trainingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function categorization_trainingRoutineBegin(snapshot) {
  return async function () {
    ...
    categorization_trainingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function cat_training_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    cat_training_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instruction_memoRoutineBegin(snapshot) {
  return async function () {
    ...
    instruction_memoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function memo_fix_isiRoutineBegin(snapshot) {
  return async function () {
    ...
    memo_fix_isiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function memo_trainingRoutineBegin(snapshot) {
  return async function () {
    ...
    memo_trainingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function memo_training_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    memo_training_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function start_categorizationRoutineBegin(snapshot) {
  return async function () {
    ...
    start_categorizationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function kitchen_aRoutineBegin(snapshot) {
  return async function () {
    ...
    kitchen_aComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function kitchen_random_isiRoutineBegin(snapshot) {
  return async function () {
    ...
    kitchen_random_isiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function kitchen_pictureRoutineBegin(snapshot) {
  return async function () {
    ...
    kitchen_pictureComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function kitchen_a_memo_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    kitchen_a_memo_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function memotest_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    memotest_taskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function kitchen_bRoutineBegin(snapshot) {
  return async function () {
    ...
    kitchen_bComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function kitchen_b_memo_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    kitchen_b_memo_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function living_aRoutineBegin(snapshot) {
  return async function () {
    ...
    living_aComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function living_random_isiRoutineBegin(snapshot) {
  return async function () {
    ...
    living_random_isiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function living_pictureRoutineBegin(snapshot) {
  return async function () {
    ...
    living_pictureComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function living_a_memotest_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    living_a_memotest_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function living_bRoutineBegin(snapshot) {
  return async function () {
    ...
    living_bComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function living_b_memotest_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    living_b_memotest_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function sleep_aRoutineBegin(snapshot) {
  return async function () {
    ...
    sleep_aComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function sleep_random_isiRoutineBegin(snapshot) {
  return async function () {
    ...
    sleep_random_isiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function sleep_pictureRoutineBegin(snapshot) {
  return async function () {
    ...
    sleep_pictureComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bed_a_memotest_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    bed_a_memotest_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function sleep_bRoutineBegin(snapshot) {
  return async function () {
    ...
    sleep_bComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bed_b_memotest_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    bed_b_memotest_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function middle_breakRoutineBegin(snapshot) {
  return async function () {
    ...
    middle_breakComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
